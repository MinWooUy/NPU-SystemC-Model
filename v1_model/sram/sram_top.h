    ...
    private:
        ...
        void beh_process()
        {
            ...
            if (i_srama_rden.read())
            {
                ...
                {
                    std::cout << "[SRAM A NPU READ] count=" << dbg_srama_read_count
                              << " npu_a_idx=" << npu_a_idx
                    ...
                    {
                        std::cout << static_cast<int>(data_a[i]);
                        if (i < Y_DIM - 1)
                            std::cout << ", ";
                    }
            ...
            if (i_sramb_rden.read())
            {
                ...
                {
                    std::cout << "[SRAM B NPU READ] count=" << dbg_sramb_read_count
                              << " npu_b_idx=" << npu_b_idx
                    ...
                    {
                        std::cout << static_cast<int>(data_b[i]);
                        if (i < X_DIM - 1)
                            std::cout << ", ";
                    }
            ...
            if (i_sramc_wren.read())
            {
                ...
                {
                    std::cout << "[SRAM C NPU WRITE] count="
